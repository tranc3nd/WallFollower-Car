...
// Initializes AIN2, AIN9, AIN8, and AIN1 sampling
// 125k max sampling
...
//  SYSCTL_RCGC0_R |= 0x00010000; // 1) activate ADC0 (legacy code)
  ...
  GPIO_PORTE_PCTL_R = GPIO_PORTE_PCTL_R&0xFF00F00F;
...
// Samples AIN8, AIN9, AIN2, and AIN1
// 125k max sampling
...
// ain8 (PE5) 0 to 4095
// ain1 (PE2) 0 to 1450
void ADC_In298(uint16_t *ain2, uint16_t *ain9, uint16_t *ain8, uint16_t *ain1){
  ...
  *ain8 = ADC0_SSFIFO2_R&0xFFF;    // 3C) read third result
	*ain1 = ADC0_SSFIFO2_R&0xFFF;    // P-Monitor    
